...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    $data.='<tr><td colspan="2" align="center" style="font-weight: 700;font-size: 17px;">Contact Us :-</td></tr>';/* field name */

    $data.='<tr><td style="font-weight: 600;font-size: 15px;">Name :</td><td style="font-weight: 600;font-size: 15px;">'.$_POST['name'].'</td></tr>';

    $data.='<tr><td style="font-weight: 600;font-size: 15px;">Phone No : </td><td style="font-weight: 600;font-size: 15px;">'.$_POST['phoneno'].'</td></tr>';

    $data.='<tr><td style="font-weight: 600;font-size: 15px;"> Email :</td><td style="font-weight: 600;font-size: 15px;">'.$_POST['email'].'</td></tr>';

    $data.='<tr><td style="font-weight: 600;font-size: 15px;">City : </td><td style="font-weight: 600;font-size: 15px;">'.$_POST['city'].'</td></tr>';
