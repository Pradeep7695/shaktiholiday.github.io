...
<div class="page-title">
	<h2><span class="fa fa-arrow-circle-o-left"></span> Add international Package</h2>
...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			<?= form_open_multipart('dashboard/create_international_package',['class'=>'form-horizontal'])?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'form-control','name'=>'intern_trip_name','placeholder'=>'Package Name','value'=>set_value('intern_trip_name')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'form-control','name'=>'intern_trip_price','placeholder'=>'Package Price','value'=>set_value('intern_trip_price')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'form-control','name'=>'intern_trip_day','placeholder'=>'ex. 5 DAYS 4 NIGHTS','value'=>set_value('intern_trip_day')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_textarea(['class'=>'ckeditor','name'=>'intern_trip_desc','placeholder'=>'Package Description','value'=>set_value('intern_trip_desc')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'file multiple','type'=>'file','id'=>'input-b3','data-browse-on-zone-click'=>'TRUE','data-show-upload'=>'false','data-show-caption'=>'true','name'=>'intern_trip_img'])?>
						</div>
					</div>
