...
<div class="page-title">
	<h2><span class="fa fa-arrow-circle-o-left"></span> Edit Tour Package</h2>
...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			<?= form_open_multipart("dashboard/update_tour/{$tour_package->id}",['class'=>'form-horizontal'])?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'form-control','name'=>'trip_name','placeholder'=>'Package Name','value'=>set_value("trip_name",$tour_package->trip_name)])?>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'form-control','name'=>'package_price','placeholder'=>'Package Price','value'=>set_value('trip_day',$tour_package->package_price)])?>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'form-control','name'=>'trip_day','placeholder'=>'ex. 5 DAYS 4 NIGHTS','value'=>set_value('trip_day',$tour_package->trip_day)])?>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<textarea class="ckeditor" id="content" name="trip_desc"><?= $tour_package->trip_desc?></textarea>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<input type="file" name="trip_img" value="" class="file multiple" id="input-b3" data-browse-on-zone-click="TRUE" data-show-upload="false" data-show-caption="true" data-initial-preview="<img width='150' height='150' src='<?= $tour_package->trip_img?>'/>"  />
