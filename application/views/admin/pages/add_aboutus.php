...
<div class="page-title">
	...
	<div class="form-group pull-right">
		<button class="btn btn-info" onclick="window.location.href='<?= base_url('dashboard/show_aboutUs')?>';"><i class="fa fa-reply"></i> About Us Table </button>
	</div>
</div>
...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			<?= form_open_multipart('dashboard/createAboutUs',['class'=>'form-horizontal'])?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_textarea(['class'=>'form-control','name'=>'about_desc','placeholder'=>'About Us Description','value'=>set_value('about_desc')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'form-control','name'=>'service1','placeholder'=>'About Us Service 1','value'=>set_value('service1')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'form-control','name'=>'service2','placeholder'=>'About Us Service 2','value'=>set_value('service2')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'form-control','name'=>'service3','placeholder'=>'About Us Service 3','value'=>set_value('service3')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'form-control','name'=>'service4','placeholder'=>'About Us Service 4','value'=>set_value('service4')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-9">
							<?= form_input(['class'=>'file multiple','type'=>'file','id'=>'input-b3','data-browse-on-zone-click'=>'TRUE','data-show-upload'=>'false','data-show-caption'=>'true','name'=>'about_img'])?>
						</div>
					</div>
