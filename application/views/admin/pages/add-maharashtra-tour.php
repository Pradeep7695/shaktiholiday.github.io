...
<div class="page-title">
	<h2><span class="fa fa-arrow-circle-o-left"></span> Add Maharashtra Tour</h2>
...
<div class="page-content-wrap">
	<div class="container">
		...
		<div class="row">
			<?= form_open_multipart('dashboard/create_maharashtra_tour',['class'=>'form-horizontal'])?>
									...
									<div class="row">
										<div class="form-group">
											<div class="col-md-10">
												...
												<?= form_input(['class'=>'form-control','name'=>'mh_tour_name','placeholder'=>'Tour Name','value'=>set_value('mh_tour_name')])?>
										...
										<div class="form-group">
											<div class="col-md-10">
												...
												<?= form_input(['class'=>'form-control','name'=>'tour_duration','placeholder'=>'Tour Trip Duration (ex.- 3 Day 2 Night )','value'=>set_value('tour_duration')])?>
										...
										<div class="form-group">
											<div class="col-md-10">
												...
												<?= form_input(['class'=>'form-control','name'=>'tour_day','placeholder'=>'Tour Day (ex.- Only Saturday)','value'=>set_value('tour_day')])?>
										...
										<div class="form-group">
											<div class="col-md-10">
												...
												<?= form_input(['class'=>'file multiple','type'=>'file','id'=>'input-b3','data-browse-on-zone-click'=>'TRUE','data-show-upload'=>'false','data-show-caption'=>'true','name'=>'mh_tour_img'])?>
											</div>
										</div>
									...
									<div class="row">
										<div class="form-group">
											<div class="col-md-10">
												...
												<?= form_textarea(['class'=>'ckeditor','name'=>'inclusion_exclution','placeholder'=>'Package Description','value'=>set_value('inclusion_exclution')])?>
									...
									<div class="row">
										<div class="form-group">
											<div class="col-md-10">
												...
												<?= form_textarea(['class'=>'ckeditor','name'=>'depature_date','placeholder'=>'Package Description','value'=>set_value('depature_date')])?>
