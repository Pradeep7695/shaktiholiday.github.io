...
<div class="page-title">
	<h2><span class="fa fa-arrow-circle-o-left"></span> Add Popular Tour</h2>
	<div class="form-group pull-right">
		<button class="btn btn-info" onclick="window.location.href='<?= base_url('dashboard/show_popular_tour')?>';"><i class="fa fa-reply"></i> Popular Tour Table </button>
	</div>
</div>
...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			<?= form_open_multipart('dashboard/storePopularTour',['class'=>'form-horizontal'])?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_input(['class'=>'form-control','name'=>'package_name','placeholder'=>'Package Name','value'=>set_value('package_name')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_input(['class'=>'form-control','name'=>'url_link','placeholder'=>'Package Url Link (eg. https://www.google.com/)','value'=>set_value('url_link')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_input(['class'=>'file multiple','type'=>'file','id'=>'input-b3','data-browse-on-zone-click'=>'TRUE','data-show-upload'=>'false','data-show-caption'=>'true','name'=>'package_img'])?>
						</div>
					</div>
