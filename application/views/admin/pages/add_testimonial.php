...
<div class="page-title">
	<h2><span class="fa fa-arrow-circle-o-left"></span> Add Testimonial</h2>
...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			<?= form_open_multipart('dashboard/createTestimonial',['class'=>'form-horizontal'])?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_input(['class'=>'form-control','name'=>'client_name','placeholder'=>'client Name','value'=>set_value('client_name')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_textarea(['class'=>'ckeditor','name'=>'review','placeholder'=>'client Review','value'=>set_value('review')])?>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_input(['class'=>'file multiple','type'=>'file','id'=>'input-b3','data-browse-on-zone-click'=>'TRUE','data-show-upload'=>'false','data-show-caption'=>'true','name'=>'client_img'])?>
						</div>
					</div>
