...
<div class="page-title">
	<h2><span class="fa fa-arrow-circle-o-left"></span> Edit Image Gallery</h2>
...
<div class="page-content-wrap">
	<div class="row">
		<div class="col-md-12">
			<?= form_open_multipart("dashboard/update_img/{$ImgData->id}",['class'=>'form-horizontal'])?>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="form-group">
						...
						<div class="col-md-10">
							<?= form_input(['class'=>'form-control','name'=>'img_name','placeholder'=>'Image Title','value'=>set_value("img_name",$ImgData->img_name)])?>
					...
					<div class="form-group">
						...
						<div class="col-md-10">
							<input type="file" name="t_img" value="" class="file multiple" id="input-b3" data-browse-on-zone-click="TRUE" data-show-upload="false" data-show-caption="true" data-initial-preview="<img width='150' height='150' src='<?= $ImgData->t_img?>'/>"  />
						</div>
					</div>
