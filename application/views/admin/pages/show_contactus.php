...
<ul class="breadcrumb">
	<li><a href="#">Home</a></li>
	<li class="active">Show Contact Us</li>
</ul>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<div class="table-responsive">
						<table id="contact_us" class="table table-bordered table-striped table-actions">
							<thead>
							<tr>
								<th>Id</th>
								<th>Contact No</th>
							...
							<tbody>
							<?php if ($contactAll):?>
								<?php foreach ($contactAll as $contactAll):?>
									<tr>
										<td><?= $contactAll->id;?></td>
										<td><?= $contactAll->contactno;?></td>
										<td><?= $contactAll->email;?></td>
										<td><?= $contactAll->address?></td>
										<td><?= date('d-m-Y',strtotime($contactAll->created_at))?></td>
										<td>
											<?php
											echo anchor("dashboard/edit_contactUs/". $contactAll->id,'<button class="btn btn-info btn-condensed"><i class="fa fa-edit"></i></button>');
