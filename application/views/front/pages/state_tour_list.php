					...
					<ul class="nav navbar-nav menu-main-menu side-nav" id="mobile-demo">
						...
						<li class="<?php if ($page == 'domestic'){echo 'current-menu-ancestor';}?> menu-item-has-children">
							...
							<ul class="sub-menu">
								...
								<li><a href="<?= base_url('international_package')?>"><i class="fa fa-angle-right"></i> Cruise</a></li>
							</ul>
						</li>
			...
			<div class="banner-wrapper container article_heading">
				<div class="breadcrumbs-wrapper">
					<ul class="phys-breadcrumb">
						...
						<li class="active">State Tour List</li>
					</ul>
				</div>
				<h1 class="heading_primary">State Tour List</h1></div>
		</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="site-main col-sm-12 full-width">
						<ul class="tours products wrapper-tours-slider" id="domestic-state-tour">
						<?php if (count($stateTourList)):?>
						   <?php foreach ($stateTourList as $item):?>
								<li class="item-tour col-md-4 col-sm-6 product" id="state_tour_list">
									<div class="item_border item-product">
										<div class="post_images state-img">
											<a href="<?= base_url("/home/single_tour_details/".$item->domestic_tour_id)?>">
												<img width="430" height="305" src="<?= $item->domestic_tour_img;?>" alt="<?= $item->domestic_tour_name;?>" title="<?= $item->domestic_tour_name;?>">
											</a>
										</div>

										<div class="wrapper_content">
											<div class="post_title"><h4>
													<a href="<?= base_url("/home/single_tour_details/".$item->domestic_tour_id)?>" rel="bookmark"><?= $item->domestic_tour_name;?></a>
												</h4>
											</div>

											<div class="description">
												<p><i class="fa fa-calendar"></i> <?= $item->domestic_tour_duration;?></p>
											</div>
										</div>
										<div class="read_more">
											...
											<a rel="nofollow" href="<?= base_url("/home/single_tour_details/".$item->domestic_tour_id)?>" class="button product_type_tour_phys add_to_cart_button">View Details</a>
										</div>
									</div>
								</li>
							<?php endforeach;?>
