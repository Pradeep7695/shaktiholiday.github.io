		...
		<div class="banner-wrapper container article_heading">
			<div class="breadcrumbs-wrapper">
				<ul class="phys-breadcrumb">
					...
					<?php if ($MaharashtraTourDetails):?>
					   <?php foreach ($MaharashtraTourDetails as $MaharashtraTourDetails):?>
							<li><?=$MaharashtraTourDetails->mh_tour_name ?></li>
					   <?php endforeach;?>
					<?php endif;?>
				</ul>
			</div>
			<h1 class="heading_primary"><?=$MaharashtraTourDetails->mh_tour_name ?></h1></div>
	</div>
</div>
											...
											<div class="row">
												<div class="inclusion-exclusion">
													...
													<div class="inclsion-data">
														<?=$MaharashtraTourDetails->inclusion_exclution ?>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="row">
												<div class="inclusion-exclusion">
													...
													<div class="itar-text pull-left">
														<p><i class="fa fa-hand-o-right"></i> <?=$MaharashtraTourDetails->tour_duration ?></p>
													</div>
													<div class="inclsion-data">
														<?=$MaharashtraTourDetails->itinerary ?>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-md-12">
											<div class="row">
												<div class="inclusion-exclusion">
													...
													<div class="inclsion-data">
														<?=$MaharashtraTourDetails->tour_cost?>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="tab-pane" id="tab_default_5">
									<div class="container">
										<div class="col-md-12">
											<div class="row">
												<div class="inclusion-exclusion">
													<h1 class="title">Departure Date </h1>
													<div class="inclsion-data">
														<?=$MaharashtraTourDetails->depature_date?>
													</div>
												</div>
											</div>
										</div>
