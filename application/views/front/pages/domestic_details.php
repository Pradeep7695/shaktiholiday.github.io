...
<div class="wrapper-container">
						...
						<aside id="text-15" class="widget_text">
							<div class="textwidget">
								<ul class="top_bar_info clearfix">
									...
									<li><i class="fa fa-envelope-o"></i> info@thetravelfirm.in</li>
	...
	<?php if ($domesticDetails):?>
<?php foreach ($domesticDetails as $domesticDetails):?>
			...
			<div class="banner-wrapper container article_heading">
				<div class="breadcrumbs-wrapper">
					<ul class="phys-breadcrumb">
						...
						<li><a href="javaScript:void(0);">Domestic Package Deatils </a></li>
						<li><a href="javaScript:void(0);"><?= $domesticDetails->domestic_trip_name?> </a></li>
					</ul>
				</div>
				<h2 class="heading_primary"><?= $domesticDetails->domestic_trip_name;?></h2></div>
		</div>
		<section class="content-area single-woo-tour" id="packages-full-details">
			<div class="container">
					  ...
					  --><?php /*foreach ($tourPackage as $tourPackage):*/?>
						<div class="images images_single_left">
							<div class="title-single">
								<div class="title">
									<h1><?= $domesticDetails->domestic_trip_name?></h1>
								</div>
								<div class="tour_code">
									<strong>Trip Duration: </strong><?= $domesticDetails->domestic_trip_day;?>
								</div>
							</div>

							<div class="tour-details">
								<div class="tour-img">
									<img class="img-responsive" src="<?= $domesticDetails->domestic_img?>">
								</div>
							</div>
						...
						<div class="summary entry-summary description_single">
							<div class="affix-sidebar">
								<div class="entry-content-tour">
									<p class="price">
										<span class="text">Price:</span><span class="travel_tour-Price-amount amount"><i class="fa fa-inr"></i> <?= $domesticDetails->domestic_price?></span>
									</p>
									<div class="clear"></div>
									<div class="booking">
										<div class="">
