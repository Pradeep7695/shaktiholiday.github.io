		...
		<div class="banner-wrapper container article_heading">
			<div class="breadcrumbs-wrapper">
				<ul class="phys-breadcrumb">
					...
					<li class="active"><?= $internationalSingleData->c_tour_name?></li>
				</ul>
			</div>
			<h1 class="heading_primary"><?=$internationalSingleData->c_tour_name ?></h1></div>
	</div>
</div>
				...
				<div class="state_tour_details1">
					<div class="images images_single_left">
						<div class="title-single">
							<div class="title">
								<h1><i class="fa fa-tree"></i> <?= $internationalSingleData->c_tour_name?></h1>
							</div>
							<div class="tour_code">
								<p><strong>Trip Duration: </strong><i class="fa fa-calendar"></i> <?= $internationalSingleData->c_tour_duration?></p>
							</div>
						</div>

						<div class="tour-details">
							<div class="tour-img">
								<img class="img-responsive" src="<?= $internationalSingleData->c_tour_img?>">
							</div>
						</div>
											...
											<div class="row">
												<div class="inclusion-exclusion">
													...
													<div class="inclsion-data">
														<?= $internationalSingleData->c_inclusion_exclusion ?>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="row">
												<div class="inclusion-exclusion">
													...
													<div class="itar-text pull-left">
														<p><i class="fa fa-hand-o-right"></i> <?=  $internationalSingleData->c_tour_duration ?></p>
													</div>
													<div class="inclsion-data">
														<?=$internationalSingleData->c_itenary ?>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-md-12">
											<div class="row">
												<div class="inclusion-exclusion">
													...
													<div class="inclsion-data">
														<?=$internationalSingleData->c_tour_cost?>
													</div>
												</div>
											</div>
										</div>
										...
										<div class="col-md-12">
											<div class="row">
												<div class="inclusion-exclusion">
													...
													<div class="inclsion-data">
														<?=$internationalSingleData->c_tour_date?>
													</div>
												</div>
											</div>
										</div>
