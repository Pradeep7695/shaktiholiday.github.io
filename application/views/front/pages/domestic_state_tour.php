			...
			<div class="container-fostrap">
				<div class="content">
					<div class="container">
						...
						<div class="row">
						<?php if ($stateCategory):?>
							<?php foreach ($stateCategory as $stateCategory):?>
							 <div class="col-xs-12 col-sm-4">
								<div class="card">
									<a class="img-card" href="<?= base_url("/home/state_tour_list/".$stateCategory->state_tour_id)?>">
										<img src="<?= $stateCategory->state_tour_img;?>" />
									</a>
									<div class="card-content">
										<h4 class="card-title">
											<a class="text-center" href="<?= base_url("/home/state_tour_list/".$stateCategory->state_tour_id)?>">
												<?= $stateCategory->state_name;?>
											</a>
										</h4>
										<p class="card-desc">
											<?= $stateCategory->state_tour_des;?>
										</p>
									</div>
									<div class="card-read-more">
										<a href="<?= base_url("/home/state_tour_list/".$stateCategory->state_tour_id)?>" class="btn btn-link btn-block">
											View <?= $stateCategory->state_name;?> Tours
										</a>
									</div>
								</div>
							</div>
