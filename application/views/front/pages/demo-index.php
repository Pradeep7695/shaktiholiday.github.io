...
<head>
	...
	<link rel="stylesheet" href="<?= base_url('assets/css/flaticon.css')?>" type="text/css" media="all">
	<link rel="stylesheet" href="<?= base_url('assets/css/font-linearicons.css')?>" type="text/css" media="all">
	<link rel="stylesheet" href="<?= base_url('assets/css/style.css')?>" type="text/css" media="all">
	<link rel="stylesheet" href="<?= base_url('assets/css/travel-setting.css')?>" type="text/css" media="all">
			...
			<div class="container">
				...
				<div class="width-logo sm-logo">
					<a href="#" title="Travel" rel="home">
						<img src="<?= base_url('assets/images/logo.png')?>" alt="Logo" width="474" height="130" class="logo_transparent_static">
						<img src="<?= base_url('assets/images/logo_sticky.png')?>" alt="Sticky logo" width="474" height="130" class="logo_sticky">
					</a>
				</div>
				<nav class="width-navigation">
					<ul class="nav navbar-nav menu-main-menu side-nav" id="mobile-demo">
						...
						<li class="menu-item-has-children">
							<a href="tours.html">Our services</a>
							<ul class="sub-menu">
						...
						<li><a href="destinations.html">Domestic & International</a></li>
	...
	<div class="site wrapper-content">
		<div class="home-content" role="main">
			<div class="wrapper-bg-video">
				<video poster="<?= base_url('assets/images/video_slider.jpg')?>" playsinline autoplay muted loop>
									...
									<div class="item_content">
										<div class="post_images">
											...
											<span class="price"><del>
												...
												<img src="<?= base_url('assets/images/tour/430x305/tour-1.jpg')?>" alt="" title="">
											</a>
									...
									<div class="item_content">
										<div class="post_images">
											...
											<span class="price">
												...
												<img src="<?= base_url('assets/images/tour/430x305/tour-2.jpg')?>" alt="" title="">
											</a>
											<div class="group-icon">
												<a href="#" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="River Cruise"><i class="flaticon-transport-2"></i></a>
												<a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Wildlife"><i class="flaticon-island"></i></a>
									...
									<div class="item_content">
										<div class="post_images">
											...
											<span class="price">
												...
												<img src="<?= base_url('assets/images/tour/430x305/tour-3.jpg')?>" alt="" title="">
											</a>
											<div class="group-icon">
												<a href="#" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="River Cruise"><i class="flaticon-transport-2"></i></a>
												<a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Wildlife"><i class="flaticon-island"></i></a>
									...
									<div class="item_content">
										<div class="post_images">
											...
											<span class="price">
												...
												<img src="<?= base_url('assets/images/tour/430x305/tour-4.jpg')?>" alt="" title="">
											</a>
											<div class="group-icon">
												<a href="#" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="River Cruise"><i class="flaticon-transport-2"></i></a>
												<a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Wildlife"><i class="flaticon-island"></i></a>
									...
									<div class="item_content">
										<div class="post_images">
											...
											<span class="price">
												...
												<img src="<?= base_url('assets/images/tour/430x305/tour-5.jpg')?>" alt="" title="">
											</a>
											<div class="group-icon">
												<a href="#" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="River Cruise"><i class="flaticon-transport-2"></i></a>
												<a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Wildlife"><i class="flaticon-island"></i></a>
									...
									<div class="item_content">
										<div class="post_images">
											...
											<span class="price">
												...
												<img src="<?= base_url('assets/images/tour/430x305/tour-6.jpg')?>" alt="" title="">
											</a>
											<div class="group-icon">
												<a href="#" data-toggle="tooltip" data-placement="top" title="" class="frist" data-original-title="River Cruise"><i class="flaticon-transport-2"></i></a>
												<a href="#" data-toggle="tooltip" data-placement="top" title="" data-original-title="Wildlife"><i class="flaticon-island"></i></a>
						...
						<div class="tours-type-slider" data-dots="true" data-nav="true" data-responsive='{"0":{"items":1}, "480":{"items":2}, "768":{"items":3}, "992":{"items":4}, "1200":{"items":5}}'>
							<div class="tours_type_item">
								<a href="tours.html" class="tours-type__item__image">
									<img src="<?= base_url('assets/images/city/26003147786_a04226cd2f_o.jpg')?>" alt="Brazil">
								</a>
							...
							<div class="tours_type_item">
								<a href="tours.html" class="tours-type__item__image">
									<img src="<?= base_url('assets/images/city/24987002020_29d3944b4f_o.jpg')?>" alt="Philippines">
								</a>
								<div class="content-item">
							...
							<div class="tours_type_item">
								<a href="tours.html" class="tours-type__item__image">
									<img src="<?= base_url('assets/images/city/25816508131_00e16429b8_o.jpg')?>" alt="Italy">
								</a>
								<div class="content-item">
							...
							<div class="tours_type_item">
								<a href="tours.html" class="tours-type__item__image">
									<img src="<?= base_url('assets/images/city/photo-1474181487882-5abf3f0ba6c2.jpg')?>" alt="USA">
								</a>
								<div class="content-item">
							...
							<div class="tours_type_item">
								<a href="tours.html" class="tours-type__item__image">
									<img src="<?= base_url('assets/images/city/25656857141_edcdf5e6e3_o.jpg')?>" alt="Canada">
								</a>
								<div class="content-item">
							...
							<div class="tours_type_item">
								<a href="tours.html" class="tours-type__item__image">
									<img src="<?= base_url('assets/images/city/26003147786_a04226cd2f_o.jpg')?>" alt="Cuba">
								</a>
								<div class="content-item">
							...
							<div class="tours_type_item">
								<a href="tours.html" class="tours-type__item__image">
									<img src="<?= base_url('assets/images/city/25656857141_edcdf5e6e3_o.jpg')?>" alt="Brazil">
								</a>
								<div class="content-item">
									<div class="item__title">Brazil</div>
								</div>
								...
								<div class="tours-type-slider" data-autoplay="true" data-dots="true" data-nav="false" data-responsive='{"0":{"items":1}, "480":{"items":1}, "768":{"items":1}, "992":{"items":1}, "1200":{"items":1}}'>
									<div class="tour-reviews-item">
										<div class="reviews-item-info">
											<img alt="" src="<?= base_url('assets/images/avata.jpg')?>" class="avatar avatar-95 photo" height="90" width="90">
						...
						<div class="col-sm-8">
							...
							<div class="row">
								<div class="post_list_content_unit col-sm-6">
									<div class="feature-image">
										<a href="#" class="entry-thumbnail">
											<img width="370" height="260" src="<?= base_url('assets/images/blog/201H.jpg')?>" alt="">
										</a>
									</div>
								...
								<div class="post_list_content_unit col-sm-6">
									<div class="feature-image">
										<a href="#" class="entry-thumbnail">
											<img width="370" height="260" src="<?= base_url('assets/images/blog/86H.jpg')?>" alt="">
										</a>
									</div>
									<div class="post-list-content">
										<div class="post_list_inner_content_unit">
			...
			<div class="container">
				<div class="row">
					...
					<aside class="col-sm-3 custom-instagram widget_text">
						...
						<div class="textwidget">
							<ul>
								<li><img src="<?= base_url('assets/images/instagram/1.jpg')?>" alt="instagram"></li>
								<li><img src="<?= base_url('assets/images/instagram/2.jpg')?>" alt="instagram"></li>
								<li><img src="<?= base_url('assets/images/instagram/3.jpg')?>" alt="instagram"></li>
								<li><img src="<?=  base_url('assets/images/instagram/4.jpg')?>" alt="instagram"></li>
								<li><img src="<?= base_url('assets/images/instagram/5.jpg')?>" alt="instagram"></li>
								<li><img src="<?= base_url('assets/images/instagram/6.jpg')?>" alt="instagram"></li>
							</ul>
						</div>
					</aside>
				</div>
...
<script type="text/javascript" src="<?= base_url('assets/js/jquery.mb-comingsoon.min.js')?>"></script>
