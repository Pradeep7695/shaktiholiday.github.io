			...
			<div class="banner-wrapper container article_heading">
				<div class="breadcrumbs-wrapper">
					<ul class="phys-breadcrumb">
						...
						<li>International Country Tour List</li>
					</ul>
				</div>
				<h1 class="heading_primary">International Country Tour List</h1></div>
		</div>
				...
				<div class="row">
					<div class="site-main col-sm-12 full-width">
						<ul class="tours products wrapper-tours-slider" id="domestic-state-tour">
							<?php if (count($international_tour_list)):?>
								<?php foreach ($international_tour_list as $item):?>
									<li class="item-tour col-md-4 col-sm-6 product" id="state_tour_list">
										<div class="item_border item-product">
											<div class="post_images state-img">
												<a href="<?= base_url("/home/international_tour_details/".$item->country_tour_id .'/'. $item->c_tour_name)?>">
													<img width="430" height="305" src="<?= $item->c_tour_img;?>" alt="<?= $item->c_tour_name;?>" title="<?= $item->c_tour_name;?>">
												</a>
											</div>

											<div class="wrapper_content">
												<div class="post_title"><h4>
														<a href="<?= base_url("/home/international_tour_details/".$item->country_tour_id .'/'. $item->c_tour_name)?>" rel="bookmark"><?= $item->c_tour_name;?></a>
													</h4>
												</div>

												<div class="description">
													<p><i class="fa fa-calendar"></i> <?= $item->c_tour_duration;?></p>
												</div>
											</div>
											<div class="read_more">
												...
												<a rel="nofollow" href="<?= base_url("/home/international_tour_details/".$item->country_tour_id .'/'. $item->c_tour_name)?>" class="button product_type_tour_phys add_to_cart_button">View Details</a>
											</div>
										</div>
									</li>
								<?php endforeach;?>
